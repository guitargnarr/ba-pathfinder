#!/usr/bin/env python3
"""Generate OG image for BA Pathfinder"""
...
# Icon area
center_x = 600
draw.text((center_x, 120), "BA PATHFINDER", font=font_large, fill=TEAL_400, anchor="mm")

# Title
draw.text((600, 220), "Business Analyst", font=font_bold, fill=WHITE, anchor="mm")
draw.text((600, 290), "Career Guidance", font=font_bold, fill=WHITE, anchor="mm")

# Subtitle
draw.text((600, 370), "Interactive Career Roadmaps | Skills Development", font=font_large, fill=TEAL_400, anchor="mm")

# Features
features = ["Entry Level", "Mid Level", "Senior", "Lead/Manager"]
feature_y = 480
...
# Footer
draw.text((600, 580), "ba-pathfinder.vercel.app", font=font_medium, fill=(100, 116, 139), anchor="mm")
